...
import numpy as np
from morpion_ia_ez import ai_easy


def create_board_ia_middle(win_morpion):
    """
        creer le plateau de jeu en prenant en parametre la fenetre tkinter et le retourne
    """
...
def ca_click(line, colum):
    ...
    if np_board[line, colum] == " ":
        ...
        if draw():
            ...
            player = (player + 1) % 2
            if player == 1:
                ai_play = ai_defensive()  # Utilise l'IA défensive ici
                if ai_play:
